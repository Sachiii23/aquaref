...
public class Mainspinwheel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mainspinwheel);

        btnSpin = findViewById(R.id.wheel_bg);
    ...
    public void ktp(View view){
        Intent intent = new Intent(Mainspinwheel.this, Mainscan_KTP.class);
